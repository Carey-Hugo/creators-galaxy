...
class AuditApi {
     ...
     */
    async listAuditLogs(wallet_id, principal_id, action, result, start_time, end_time, after, before, cursor, limit, X_API_Key, options) {
        ...
        if (start_time !== undefined) {
            localVarQueryParameter['start_time'] = (start_time instanceof Date) ?
                start_time.toISOString() :
                start_time;
        }
        if (end_time !== undefined) {
            localVarQueryParameter['end_time'] = (end_time instanceof Date) ?
