...
class MetadataApi {
     ...
     */
    async ethCall(EthCallRequest, X_API_Key, options) {
        ...
        (0, common_1.assertParamExists)('ethCall', 'EthCallRequest', EthCallRequest);
     ...
     * @param options Override http request option.
     */
    async searchTokens(symbol, X_API_Key, options) {
        ...
        (0, common_1.assertParamExists)('searchTokens', 'symbol', symbol);
        if (symbol !== undefined) {
