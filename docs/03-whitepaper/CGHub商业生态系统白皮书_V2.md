...
![创客星球白皮书封面](./images/whitepaper-cover.png)
...
**创客星球**（Maker Star）是一个基于"本地生活+LBS社交+AI赋能+Web3预备"的创业孵化生态系统。
...
![AI生产力、Web3生产关系与共同富裕理念融合为创客星球](./images/core-formula.png)
...
1. **参与者即股东** — 不管你持有多少代币，你都是创客星球的共建者
...
![AI超级个体通过创客星球组织网络放大影响力](./images/super-individual-organization.png)
...
**创客星球采用"创客积分（MKT）"作为参与凭证：**

| 参与方式 | 金额 | 获得 |
|---------|------|------|
| 加入创客星球 | 100 MKT | 获得创客资格+首批项目参与权 |
